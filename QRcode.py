...
img = Image.open('Fresas.jpeg') # Allows us to open CSUMB logo image #
...
img1.save("Fresas.jpeg") # Saves the new image with the updated data #

# Logo Variables For QR Insertion #
Logo_Link = 'Fresas.jpeg'
...
QRimg.save('QrCodeFresas.png')
img = Image.open('QrCodeFresas.png')
img.show()
